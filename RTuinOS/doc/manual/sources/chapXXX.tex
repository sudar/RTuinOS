...
More in general, \ident{rtos\_setEvent} is implemented as a software
...
exactly as the system timer ISR does. \ident{rtos\_setEvent} checks the
...
series of calls of \ident{rtos\_waitForEvent} and \ident{rtos\_setEvent}
...
the right receiver in a later call of \ident{rtos\_setEvent}.
