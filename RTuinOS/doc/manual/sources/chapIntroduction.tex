...
implementation of Arduino's library function \ident{delay}. Real time
operating systems characterize the professional use of \uCs{}.
...
This document introduces the basic concept of \rtos{} and gives an overview
...
commented using doxygen\footnote{See http://www.doxygen.org} tags; the
compiled doxygen documentation is part of this project but will contain
only the documentation of the global objects of \rtos. To understand the
