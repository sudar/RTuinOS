...
here are just a brief summary of whats stated there.
...
To install RTuinOS, you extract the files in the archive to a directory of
...
permitted. An Arduino installation at C:\Program Files would make the
makefile fail to compile the sources.
...
start up. (Be aware, revision 3.80 is not sufficient.)
